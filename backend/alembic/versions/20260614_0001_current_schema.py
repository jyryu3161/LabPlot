...
_IDEMPOTENT_DDL = [
    ...
    "ALTER TABLE figures ADD COLUMN IF NOT EXISTS is_favorite BOOLEAN NOT NULL DEFAULT FALSE",
    ...
    "CREATE INDEX IF NOT EXISTS ix_figures_owner_favorite_updated ON figures (owner_id, is_favorite, updated_at DESC)",
